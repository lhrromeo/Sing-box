...
# =========================
# 老王 sing-box 四合一安装脚本 (用户态版)
# vless-reality | vmess-ws | hysteria2 | tuic5
# 无 root，无 systemd，无防火墙依赖
# 安装位置: ~/.sing-box
# =========================
...
# 下载并安装 sing-box + argo + qrencode
install_singbox() {
    purple "正在安装 sing-box (用户态版)..."
...
cat > "$config_dir" <<EOF
{
  ...
  "inbounds": [
    ...
    { "type": "vmess", "tag": "vmess-ws", "listen": "::", "listen_port": 8001, "users": [{ "uuid": "$uuid" }],
